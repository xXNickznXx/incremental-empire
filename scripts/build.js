...
function build_hut() {
    $("#task .hut .time").text(intToTime(timer));
...
function build_storage() {
    $("#task .storage .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_lumberjackhut() {
    $("#task .lumberjackhut .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_sheepstall() {
    $("#task .sheepstall .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_quarry() {
    $("#task .quarry .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_coalmine() {
    $("#task .coalmine .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_ironmine() {
    $("#task .ironmine .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_tailorhouse() {
    $("#task .tailorhouse .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_alchemisthut() {
    $("#task .alchemisthut .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_forge() {
    $("#task .forge .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_market() {
    $("#task .market .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_scoutpost() {
    $("#task .scoutpost .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_barracks() {
    $("#task .barracks .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
...
function build_stable() {
    $("#task .stable .time").text(intToTime(timer));
    timer = Number((timer - 0.1).toFixed(1));
    if (timer < 0) {
